...
class ApiClient:
    ...
    def __init__(self, configuration=..., header_name=..., header_value=..., cookie=...) -> None:
        ...
    ...
    def call_api(self, resource_path, method, path_params=..., query_params=..., header_params=..., body=..., post_params=..., files=..., response_type=..., auth_settings=..., async_req=..., _return_http_data_only=..., collection_formats=..., _preload_content=..., _request_timeout=...): # -> str | list[Any] | dict[Any, Any] | _Date | datetime | tuple[str | list[Any] | dict[Any, Any] | Any | _Date | datetime | None, Any, Any] | AsyncResult | None:
